...
#------------------------------
    ...
    clawdata.upper[0] = 180       # east longitude

    clawdata.lower[1] = -9.99       # south latitude
    clawdata.upper[1] = 50       # north latitude



    # Number of grid cells: Coarsest grid
    clawdata.num_cells[0] = int(1350/2)
    clawdata.num_cells[1] = int(1801/2)
    ...
    tframes = np.linspace(0,7200,25)
    tframes = np.hstack([tframes, 1.0, 2.0])
    tframes.sort()
...
#-------------------
    ...
    dtopo_path = '../data/usgs.tt3'
    dtopo_data.dtopofiles.append([3,1,3,dtopo_path])
