...
#Job Description: NZ30sec bathymetry, Spherical Coordinates for code testing
 Total run time (Wall clock, seconds)           :  14400.000
...
#===============================================:===============================
 ...
 Focal Depth                             (meter):   35000.000
 Length of source area                   (meter):   450000.000
 Width of source area                    (meter):   10.000
 Dislocation of fault plate              (meter):    1500.000
 Strike direction (theta)               (degree):   16.000
 Dip  angle       (delta)               (degree):    14.000
 Slip angle       (lamda)               (degree):    15.000
 Origin of Comp. Domain (Layer 01) (Lat, degree):   -60.0
 Origin of Comp. Domain (Layer 01) (Lon, degree):   -120.0
 Epicenter: Latitude                    (degree):   -35.826
 Epicenter: Longitude                   (degree):   -72.668
...
#===============================================:===============================
 ...
 Grid Size  (dx, sph:minute, cart:meter)        :     10.0
 Time step                            ( second ):     16.62
 ...
 Y_Start                                        :     -60.0
 Y_end                                          :      0.0
 File Name of Bathymetry Data                   :bathymetry_SA.xyz
